 ...
 */
class Picture extends \BO\OccasionBundle\Entity\Picture implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BO\\OccasionBundle\\Entity\\Picture' . "\0" . 'advert', '' . "\0" . 'BO\\OccasionBundle\\Entity\\Picture' . "\0" . 'id', '' . "\0" . 'BO\\OccasionBundle\\Entity\\Picture' . "\0" . 'url', '' . "\0" . 'BO\\OccasionBundle\\Entity\\Picture' . "\0" . 'alt', '' . "\0" . 'BO\\OccasionBundle\\Entity\\Picture' . "\0" . 'file', '' . "\0" . 'BO\\OccasionBundle\\Entity\\Picture' . "\0" . 'tempFilename'];
        }
